...
function Navbar() {
    ...
    useEffect(() => {
        const fetchCategories = async () => {   // ✅ async function banaya
            try {
        ...
        fetchCategories();  // ✅ function ko call kiya
    }, []);
                                ...
                                <li key={index}>
                                    {
                                        link.title === "Catalog" ? (
                                            ...
                                            <div className='relative flex gap-1 items-center group cursor-pointer'>
                                                <p>{link.title}</p>
                                                <MdKeyboardArrowDown />
